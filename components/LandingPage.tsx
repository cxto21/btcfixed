...
const partnerLogos = [
  { name: 'Starknet', src: 'https://images.ctfassets.net/mcxwnmool9vd/1WlPo0lI1eq1fQ5ft3lgTv/b7f87dd05766bedba8cf8a876aee5695/logo-starknet.png?f=center&fit=fill&w=640&h=237&q=75', white: true, scale: 1.5 },
