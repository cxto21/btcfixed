...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-on-background relative overflow-hidden">
      ...
      {/* ── Hero Section ── */}
      <main className="relative z-10 min-h-screen flex flex-col justify-center items-center py-20 px-6 md:px-16 lg:px-24">
        <section className="max-w-6xl mx-auto relative z-10 w-full">
            ...
            <div className="flex-1 text-left">
              ...
              <div className="mb-6">
                <img
                  src="/BTCFixed-Logotype.png"
                  alt="BTCFixed"
                  className="h-32 md:h-44 w-auto object-contain mb-2"
                />
                <div className="w-48 h-2.5 bg-primary rounded-full" />
              </div>

              {/* Subtitle */}
              <p className="font-headline-md text-headline-md text-on-surface-variant mb-10 max-w-lg">
